...
solo=glm(spike~  
             #keywords_df300 #negative 冷h
           #keywords_df3450 #Lag2 negative 冷h
           #keywords_df1736.high #pct count 冷h
         #Lag1.Brand39
         #Brand39
...
#keywords_df1231.high #count 冷h
    ###################################################Lag1.nonwoven.high
...
#Lag3.Brand39
###############################################keywords_df7723.high #Roll3 count 冷h
#####################################################regular.high
###########################other_share.low
##############no.high
##############Lag1.no.high
...
#	keywords_df2995.high #Lag1 count 仟侏コロナウイルス
...
#	Lag3.no_share.high
#	keywords_df5050 #Lag3 positive 嶄忽
#	Lag2.cloth.high
#	DiffLag3.yes.low
#	disease.high
...
topics_keywords = glm(spike~
                        ...
                        #	keywords_df7218.low        +              #DiffLag3 count 冷h
                        #keywords_df1736.low            +              #pct count 冷h	
                        #	keywords_df8228.high           +             #DiffRoll3 count 冷h
                        
                        keywords_df2995.high          +             #Lag1 count 仟侏コロナウイルス
                        # keywords_df1674.high           +          #pct count 仟侏コロナウイルス	
                        #	keywords_df4318.high            +       #Lag2 count 仟侏コロナウイルス
                        
                        #	keywords_df7523.high         +              #Roll3 count マスク
                        #keywords_df1556.high         +         #pct count 嶄忽	
                        keywords_df1051.high         +           #count 嶄忽      
